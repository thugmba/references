# 1173 Machine Learning for Business Analytics — Reference List

_Updated: 2026-07-27_  
_Total references: 9_
...
1. *AI student success predictor: Enhancing personalized learning in campus management systems.* Shoaib, M., Sayed, N., Singh, J., Shafi, J., et al. (2024). *Computers in Human Behavior*. <https://doi.org/10.1016/j.chb.2024.108301>
   - Teaching use: Clear predictive-modeling case for discussing target definition, model evaluation, and decision support in an organizational management system.

2. *Next Generation of Electric Vehicles: AI-Driven Approaches for Predictive Maintenance and Battery Management.* Cavus, M., Dissanayake, D., & Bell, M. (2025). *Energies*. <https://doi.org/10.3390/en18051041>
